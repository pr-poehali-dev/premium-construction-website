...
const SERVICES = [
  {
    ...
    text: 'Профессиональное утепление фасадов домов современными материалами: снижаем теплопотери и продлеваем срок службы здания.',
  },
  {
    icon: 'Paintbrush',
    title: 'Отделка фасадов',
    text: 'Декоративная штукатурка, облицовка, покраска и финишная отделка фасадов любой сложности под ключ.',
  },
  {
    icon: 'PaintRoller',
    title: 'Ремонт квартир',
    text: 'Капитальный и косметический ремонт квартир любого метража — качественно, в срок, с официальной гарантией.',
  },
  {
    icon: 'Sparkles',
    title: 'Отделка квартир',
    text: 'Чистовая и дизайнерская отделка квартир: стяжка, штукатурка, укладка плитки, обои, покраска, потолки.',
  },
  {
    icon: 'Home',
    title: 'Ремонт частных домов',
    text: 'Внутренний ремонт и отделка частных домов под индивидуальные пожелания — от черновых до финишных работ.',
  },
  {
    icon: 'Gem',
    title: 'Отделка коттеджей',
    text: 'Премиальная внутренняя отделка коттеджей с применением дорогих материалов и авторским контролем качества.',
  },
];
...
const CALC_TYPES = [
  ...
  { id: 'facade', label: 'Фасад дома', icon: 'Layers', base: 3500 },
  { id: 'house', label: 'Частный дом', icon: 'Home', base: 9500 },
];
